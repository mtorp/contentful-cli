...
function warning(...args) {
  const styledArgs = args.pipe(map(arg => warningStyle(arg)))
...
function success(...args) {
  const styledArgs = args.pipe(map(arg => successStyle(arg)))
  console.log(...styledArgs)
}
...
function error(...args) {
  const styledArgs = args.pipe(map(arg => errorStyle(arg)))
